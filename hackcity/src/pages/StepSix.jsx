    ...
    <div className="">
      <section className="flex text-center md:flex-row">
        ...
        <div className="p-8 text-left mt-4 ml-10 z-30">
          ...
          <hr className="border relative top-[12px] border-[6px] w-[700px] rounded-2xl border-[#032555]" />
        ...
        <p className = 'text-center w-[300px] text-[15px] mb-5 mt-4'>
          Thank you for reaching out to us with the important details of your
          project. One of the management team will reach out to you within
          24hours.
        </p>
