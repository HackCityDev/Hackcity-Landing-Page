...
function Services() {
  return (
    <div className="services">
      ...
      <section className="flex items-center flex-col md:flex-row justify-evenly py-12 px-6 md:px-20">
        <div className="rounded-[14px] mb-10 md:mb-0 p-5 shadow-inner shadow-2xl w-[300px] h-[350px]">
