...
function Hero() {
  return (
    <div className="hero-wrapper bg-[#f1f6fd] lg:h-[600px]">
      <div className="hero flex flex-col items-center py-10 px-4 md:flex-row md:py-8 md:px-8 lg:px-24 justify-between">
        <div className="hero-text z-20 md:w-[70%] lg:w-[80%] xl:w-[60%]">
          <h5 className="text-[#eb5757] font-semibold mb-2 mt-4 md:mt-0 md:mb-4">
            HackCity Tech Inc.
          </h5>
          <h1 className="text-[#032555] text-[30px] md:text-[30px] mb-6 font-semibold md:text-[35px] lg:text-[43px] md:leading-[60px] md:mb-8">
            Tech Innovation and Business Development Hub
          </h1>
          <p className="text-[#3a3a3a] text-[17px] leading-6 font-semibold md:text-[18px] lg:w-[75%]">
