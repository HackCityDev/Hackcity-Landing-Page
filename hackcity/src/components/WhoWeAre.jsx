    ...
    <div className="mt-10 px-4 md:px-8 lg:px-20">
      <section className="flex flex-col-reverse items-start md:flex-row justify-around">
        ...
        <div className="who-text md:w-[60%]">
          <h3 className="text-[28px] md:text-[33px] text-[#032555] font-semibold mb-5">
          ...
          <p className="who-para text-[16px] md:text-[16px] md:w-[85%] text-[3a3a3a] leading-7 mb-5 md:mb-0">
      ...
      <section className="who-card flex flex-col items-center my-14 md:flex-row justify-between px-0 :px-20">
        <div className="shadow-2xl shadow-inner rounded-[14px] mb-10 p-5 w-full h-[200px] md:w-full md:h-[200px] text-left items-center m-auto">
          ...
          <i className="text-[15px] text-gray-600">
