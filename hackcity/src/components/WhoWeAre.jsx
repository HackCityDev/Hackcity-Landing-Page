    ...
    <div className="mt-20 px-0">
      <section className="flex flex-col-reverse items-start md:flex-row justify-around">
        <div className="md:ml-10 z-20 ">
          <img src={who} className="max-h-[380px]" alt="who we are" />
        </div>

        <div className="who-text w-[60%]">
          <h3 className="text-[33px] text-[#032555] font-semibold md: mb-5">
          ...
          <p className="who-para text-[16px] w-[85%] text-[3a3a3a] leading-7">
      ...
      <section className="who-card flex items-center flex- my-14 md:flex-row justify-between px-20">
        <div className="shadow-2xl shadow-inner rounded-[14px]  p-5 w-[350px] h-[200px] text-left items-center margin-auto">
        ...
        <div className="shadow-2xl p-5 shadow-inner rounded-[14px] w-[350px] h-[200px] text-left items-center margin-auto">
          <div className="flex items-center mb-5 font-bold">
